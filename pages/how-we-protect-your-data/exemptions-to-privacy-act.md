...
<li id="frtib-2">
  <button class="usa-accordion-button"
    aria-expanded="false"
    aria-controls="frtib-2-exempt">
    FRTIB-2  | Personnel Security Investigation Files
  </button>
  <div id="frtib-2-exempt" class="usa-accordion-content" markdown="1">
...
<li id="frtib-13">
  <button class="usa-accordion-button"
    aria-expanded="false"
    aria-controls="frtib-13-exempt">
    FRTIB-13  | Fraud and Forgery Records
  </button>
  <div id="frtib-13-exempt" class="usa-accordion-content" markdown="1">
  **AGENCY:**
  ...
  **DATES:**
  Comments on this notice must be received by May 3, 2019.

  **ADDRESSES:**
  You may submit written comments to FRTIB through the following methods:

  -   [Federal eRulemaking Portal]({{ site.baseurl }}/exit/?idx=145){:rel="nofollow"}. Follow the website instructions for submitting comments.
  -   _Email:_ [privacy@tsp.gov](:mailto="privacy@tsp.gov").
  -   _Fax:_ 202-942-1676.
  ...
  **Unfunded Mandates Reform Act of 1995**
  ...
  1. The authority citation for Part 1630 continues to read as follows:<br><br>
  Authority: 5 U.S.C. 552a

  2. Amend § 1630.15 by revising paragraph (b) to read as follows:<br><br>
  § 1630.15	Exemptions.

  \* * * *

  (b) Those designated systems of records which are exempt from the requirements of subsections (c)(3); (d); (e)(1); (e)(4)(G), (H), (I); and (f) of the Privacy Act, 5 U.S.C. 552a, include FRTIB- 13, Fraud and Forgery Records.
...
<li id="frtib-14">
  <button class="usa-accordion-button"
    aria-expanded="false"
    aria-controls="frtib-14-exempt">
    FRTIB-14 | FRTIB Legal Case Files
  </button>
  <div id="frtib-14-exempt" class="usa-accordion-content" markdown="1">
...
<li id="frtib-15">
  <button class="usa-accordion-button"
    aria-expanded="false"
    aria-controls="frtib-15-exempt">
    FRTIB-15 | Internal Investigations of Harassment and Hostile Work Environment Allegations
  </button>
  <div id="frtib-15-exempt" class="usa-accordion-content" markdown="1">
