...
<div class="usa-width-one-half div-block-class div-form-class" id="tsp-u-1-pdf-block">
  <div class="item-frame">
...
<div class="usa-width-one-half ">
  ...
  <div id="inline-search-forms" class="hide">
...
<div class="usa-grid-full">  
    ...
    <div id="more-resources-4" class="see-more" onclick="showMoreForms('resources', 4);">
  <span>see more resources</span>
</div>

  </div>

  <div id="select-resources-5" class="select-resources-div hide">

    <h2 class="most-popular" id="Investments-resources">Investments resources</h2>
...
<div class="usa-width-one-half ">
  ...
  <div id="select-resources-6" class="select-resources-div hide">
  ...
  <div id="select-resources-7" class="select-resources-div hide">

    <h2 class="most-popular" id="Loans-resources">Loans resources</h2>
    <!-- # Loans Resources  -->
...
<div class="usa-width-one-half ">
  ...
  <div class="item-frame">
    ...
    <p><br /></p>
    <div id="more-resources-content-7" class="select-resources-div hide">
...
<div class="usa-width-one-half ">
  ...
  <div class="item-frame">
    ...
    <div id="more-resources-7" class="see-more" onclick="showMoreForms('resources', 7);">
  <span>see more resources</span>
</div>

  </div>

  <div id="select-resources-8" class="select-resources-div hide">
  ...
  <div id="select-resources-9" class="select-resources-div hide">
  ...
  <div id="select-resources-10" class="select-resources-div hide">

    <h2 class="most-popular" id="Withdrawals-resources">Withdrawals resources</h2>
...
<div class="usa-width-one-half ">
  ...
  <div class="item-frame">
    ...
    <p><br /></p>
    <div id="more-resources-content-10" class="select-resources-div hide">
...
<div class="usa-grid-full">  
    ...
    <div id="more-resources-10" class="see-more" onclick="showMoreForms('resources', 10);">
  <span>see more resources</span>
</div>

  </div>

  <div id="inline-search-resources" class="hide">
