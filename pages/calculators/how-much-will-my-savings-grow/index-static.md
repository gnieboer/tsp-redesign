...
<section id="savings-grow-section" class="savings-grow-table">
  <!-- DAV, the [EXPAND] & [COLLAPSE] buttons are not needed. Delete this. -->
  <!-- <div class="table-view">
  <button id="savings-grow-button" class="usa-button-secondary" onclick="toggleTableWidth('savings-grow');">
  ...
  <!-- DAV, use the following code for footnotes in all cases -->
  <!-- Footnote -->
  <div id="footnotes">
    <ol>
