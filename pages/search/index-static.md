  ...
  <div class="usa-width-one-whole">
    ...
    <section class="search-results " tabindex="-1">
      ...
      <div class="results">
        ...
        <h4 class="title">
        <a href="https://beta.tsp.gov/making-contributions/automatic-enrollment-refunds/">Automatic enrollment refunds | Thrift Savings Plan</a>
        </h4>
        <span class="url">https://beta.tsp.gov/making-contributions/automatic-enrollment-refunds/</span>
        <span class="description">

        ...account. If you make a contribution <strong>election</strong> to change your automatic contributions
        </span>
        </div>

        <div class="content-block-item result" id="result-2">
        <h4 class="title">
        <a href="https://beta.tsp.gov/making-contributions/start-change-stop-contributions/">Start, change, or stop contributions | Thrift Savings Plan</a>
        </h4>
        <span class="url">https://beta.tsp.gov/making-contributions/start-change-stop-contributions/</span>
        <span class="description">

        ...accept paper forms? Download the <strong>Election</strong> Form, Form TSP-1 (TSP-U-1 for uniformed
        </span>
        </div>
