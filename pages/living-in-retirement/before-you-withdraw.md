...
For more information on TSP installment payments and other withdrawal options, read the booklet [_Withdrawing From Your TSP Account for Separated and Beneficiary Participants_]({{ site.baseurl }}/publications/tspbk02.pdf).

For more information about RMDs and tax requirements, see the tax notice [_Important Tax Information About Your TSP Withdrawal and Required Minimum Distributions_]({{ site.baseurl }}/publications/tsp-775.pdf).
