    ...
    <li>
      ...
      <div class="panel-form-field">
        <fieldset class="usa-fieldset-inputs usa-sans">
          ...
          <!-- % input -->
          <div class="usa-input-error">
          <span class="usa-input-error-message" id="1percentage-message" role="alert">Enter a percentage.</span>
        ...
        <legend for="1earnings">Earnings options</legend>
          <ul class="usa-unstyled-list">
            ...
            <li>
              ...
              <label for="1earningsPercent" id="earningsApr">Earnings at annual percentage rate</label>
            </li>
            ...
            <li>
              ...
              <label for="1earningsPerdiem" id="earningsPerdiem">Earnings at per diem dollar rate</label>
            </li>
          </ul>

          <!-- Entitlement date input -->
          <fieldset class="usa-fieldset-inputs usa-sans">
            <legend for="1earnings">Specify the Entitlement Date:</legend>
              ...
              <!-- % input -->
              <div class="usa-input-error">
              <span class="usa-input-error-message" id="1earningsPercentRate-message" role="alert">Enter an annual percentage rate.</span>
                <span data-format="%" class="input-symbol-right">
                <input
                  aria-labelledby="earningsApr"
                  type="number"
              ...
              <span class="usa-input-error-message" id="1earningsPerdiemRate-message" role="alert">Enter a dollar amount greater than $0.01.</span>
                <span data-format="$" class="input-symbol-left">
                <input
                  aria-labelledby="earningsPerdiem"
                  type="number"
